                        ...
                        <div key={item.id} className="filmItem">
                            ...
                            <div className="filmItem__row">
                                ...
                                <ul className="card-body-stars u-clearfix">
                                    <Star raiting={(typeof item.count !== "number" || item.count < 0) ? 0 : ( (item.count > 5) ? 5 : item.count)}/>
                                </ul>
